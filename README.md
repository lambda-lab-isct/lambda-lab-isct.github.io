...
Lambda Laboratory の公式Webサイト初期版です。研究室の研究内容、メンバー、研究業績、ニュース、教育、セミナー、WCTP、アクセス・連絡先を静的サイトとして公開するためのリポジトリです。

現時点では、実在する人物、研究業績、住所、連絡先、WCTP2025/WCTP2026 の実データは登録していません。未確定情報は明確なプレースホルダーとして扱います。
